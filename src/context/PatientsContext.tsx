...
const mockPatients: Patient[] = [
  ...
  },
  {
    ...
    name: "Noah Almeida",
    age: 3,
    birthDate: "2023-03-10T10:00:00.000Z",
    cpf: "111.111.111-11",
    ...
    evolutions: [
      {
        id: "ev-baby1",
        type: "Triagem",
        professional: "Enf. Mariana Costa",
        description: "Criança de 3 anos, acompanhada da mãe. Febre 39.5°C, choro persistente, irritabilidade. Sem sinais de desidratação. PA: não aferida (pediátrico). FC: 130 bpm. FR: 28 irpm. SpO2: 97%.",
  ...
  },
  {
    ...
    name: "Helena Santos",
    age: 7,
    birthDate: "2019-05-17T10:00:00.000Z",
    cpf: "222.222.222-22",
    susCard: "700000000000003",
    status: "attending",
    risk: "very-urgent",
    arrivalTime: getPastTime(90),
    sector: "Pediatria",
    responsibleProfessional: "Dra. Claudia Ramos",
    mainComplaint: "Desconforto respiratório e sibilância",
    ticket: "PED-02",
    priority: "pediatric",
    ...
    evolutions: [
      {
        ...
        type: "Triagem",
        professional: "Enf. Mariana Costa",
        description: "Criança de 7 anos, acompanhada da mãe. Dispneia leve, sibilância bilateral, uso de musculatura acessória. Histórico de asma. FC: 110 bpm. FR: 32 irpm. SpO2: 93% em ar ambiente. Iniciado O2 por cateter nasal 2L/min.",
        timestamp: getPastTime(85),
      },
    ],
    exams: [
      {
  ...
  },
  {
    ...
    name: "José Doente",
    age: 65,
    birthDate: "1958-05-17T10:00:00.000Z",
    cpf: "333.333.333-33",
    susCard: "700000000000004",
    status: "attending",
    risk: "urgent",
    arrivalTime: getPastTime(180),
    sector: "Observação Masculina",
    responsibleProfessional: "Dr. Carlos",
    mainComplaint: "Dor no peito, falta de ar e fraqueza",
    ticket: "OBS-01",
    priority: "preferential",
    motherName: "Maria Doente",
    gender: "M",
    triaged: true,
    evolutions: [
      {
        ...
        description: "Paciente admitido com dor torácica atípica e dispneia. Sinais vitais instáveis. Iniciado protocolo de IAM e oxigenioterapia. Plano terapêutico multidisciplinar prescrito. Solicito vaga na UTI.",
