        ...
        <div className="space-y-4 py-2">
          <div className="flex gap-2 flex-wrap">
            <Button
              variant="outline"
              size="sm"
              onClick={() => applyTemplate("hemo_normal")}
            ...
            <Button
              variant="outline"
              size="sm"
              onClick={() => applyTemplate("rx_normal")}
              className="text-[10px] h-7"
            >
              Template: RX Tórax
            </Button>
            <Button
              variant="outline"
              size="sm"
              onClick={() => applyTemplate("ecg_normal")}
              className="text-[10px] h-7"
            >
              Template: ECG
            </Button>
            {exam.type === "lab" && (
              ...
              >
                <Cpu
                  className={cn("w-3 h-3 mr-1", isImporting && "animate-pulse")}
                />
          ...
          <div className="flex flex-col gap-2">
            <Label className="text-[10px] uppercase font-bold tracking-widest text-muted-foreground">
              Mini-PACS (Anexar Imagem DICOM / PDF)
            </Label>
            <div className="flex items-center gap-2">
              ...
              <Label
                htmlFor="exam-upload"
                className="flex items-center justify-center gap-2 border border-dashed border-white/20 hover:border-purple-500/50 hover:bg-purple-500/10 transition-colors w-full p-4 rounded-xl cursor-pointer"
              >
                {attachment ? (
                  ...
                  <span className="flex items-center gap-2 text-xs font-bold text-muted-foreground">
                    <UploadCloud className="w-4 h-4" /> Clique para anexar
                    arquivo
                  </span>
                )}
              </Label>
          ...
          <div className="flex items-center space-x-2 bg-red-500/10 p-3 rounded-lg border border-red-500/20">
            ...
            <Label
              ...
              className="text-red-700 dark:text-red-400 font-bold text-xs uppercase tracking-widest cursor-pointer"
            >
