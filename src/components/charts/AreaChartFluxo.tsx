...
export function AreaChartFluxo() {
  return (
        ...
        <div className="h-[250px] w-full">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={data} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
              ...
              <Area type="monotone" dataKey="entradas" name="Entradas (Triagem)" stroke="#3b82f6" strokeWidth={3} fillOpacity={1} fill="url(#colorEntradas)" />
              <Area type="monotone" dataKey="altas" name="Altas Médicas" stroke="#10b981" strokeWidth={3} fillOpacity={1} fill="url(#colorAltas)" />
            </AreaChart>
          </ResponsiveContainer>
        </div>
      </CardContent>
