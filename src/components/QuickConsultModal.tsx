...
export function QuickConsultModal({ patient, isOpen, onClose, onComplete, isPediatric, hidePediatricOptions }: QuickConsultModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent onOpenAutoFocus={(e) => e.preventDefault()} className="max-w-[1200px] w-[95vw] p-0 overflow-hidden flex flex-col bg-slate-50 dark:bg-slate-950 border-0 shadow-2xl rounded-2xl">
