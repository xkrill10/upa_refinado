...
export function WoodDownesModal({
  isOpen,
  onClose,
  onApply,
}: WoodDownesModalProps) {
  ...
  if (score >= 8) {
    ...
    conduta =
      "Risco de insuficiência respiratória. O2 contínuo, broncodilatador contínuo ou contínuo, corticoide IV, sulfato de magnésio. Considerar UTI/Suporte Ventilatório.";
  } else if (score >= 4) {
    riskClass = "CRISE MODERADA";
    riskColor = "bg-amber-500 text-white";
    conduta =
      "O2 se SatO2 < 92%. Broncodilatador de horário (a cada 20 min x3), corticoide oral ou IV. Reavaliação constante.";
  } else {
    riskClass = "CRISE LEVE";
    riskColor = "bg-emerald-500 text-white";
    conduta =
      "Broncodilatador sob demanda ou a cada 4-6h, corticoide oral. Alta após observação com melhora clínica.";
  }
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[550px] rounded-xl glass-card-premium shadow-2xl max-h-[85vh] overflow-y-auto">
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="space-y-1">
            ...
            <Select value={wheezing} onValueChange={setWheezing}>
              ...
              <SelectContent>
                ...
                <SelectItem value="2">
                  2 - Inspiratória e Expiratória
                </SelectItem>
                <SelectItem value="3">
                  3 - Audível sem esteto / Tórax silencioso
                </SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="space-y-1">
            ...
            <Select value={retractions} onValueChange={setRetractions}>
              ...
              <SelectContent>
                ...
                <SelectItem value="2">
                  2 - Generalizada (intercostal/subcostal)
                </SelectItem>
                <SelectItem value="3">
                  3 - Grave (supraclavicular, batimento aleta)
                </SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="space-y-1">
            <Label className="text-xs font-black uppercase text-foreground/80">
              Entrada de Ar (Murmúrio Vesicular)
            </Label>
            <Select value={airEntry} onValueChange={setAirEntry}>
              ...
              <SelectContent>
                ...
                <SelectItem value="1">
                  1 - Simétrica, mas levemente diminuída
                </SelectItem>
                <SelectItem value="2">2 - Muito diminuída</SelectItem>
                <SelectItem value="3">
                  3 - Ausente (tórax silencioso)
                </SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="space-y-1">
            ...
            <Select value={cyanosis} onValueChange={setCyanosis}>
              ...
              <SelectContent>
                ...
                <SelectItem value="1">
                  1 - Em ar ambiente (melhora com O2)
                </SelectItem>
