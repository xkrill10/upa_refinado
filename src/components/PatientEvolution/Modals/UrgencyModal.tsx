                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Button
                          ...
                          onClick={() => {
                            ...
                            onApply(descText, `HEART: ${score} pts (${score >= 7 ? 'Alto' : score >= 4 ? 'Mod' : 'Baixo'})`);
                            onClose(false);
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Button
                          ...
                          onClick={() => {
                            ...
                            onApply(descText, `NIHSS: ${score} pts (${score >= 21 ? 'Grave' : score >= 5 ? 'Mod' : 'Leve'})`);
                            onClose(false);
                    ...
                    <div className="mt-4 p-4 rounded-2xl bg-slate-50/70 dark:bg-slate-900/40 backdrop-blur-md border border-slate-200/60 dark:border-slate-800/50 space-y-3">
                      ...
                      <div className="flex items-center gap-2">
                        <Button
                          ...
                          variant="outline"
                          onClick={() => {
                            setCrbConfusion("0"); setCrbRate("0"); setCrbBp("0"); setCrbAge("0");
                            toast.info("Campos da calculadora limpos.");
                          }}
                        ...
                        <Button
                          ...
                          onClick={() => {
                            ...
                            onApply(descText, `CRB-65: ${score} pts (${score >= 3 ? 'Grave' : score >= 1 ? 'Mod' : 'Ambulat'})`);
                            onClose(false);
                    ...
                    <div className="mt-4 p-4 rounded-2xl bg-slate-50/70 dark:bg-slate-900/40 backdrop-blur-md border border-slate-200/60 dark:border-slate-800/50 space-y-3">
                      ...
                      <div className="flex items-center gap-2">
                        <Button
                          ...
                          variant="outline"
                          onClick={() => {
                            setWellsTvp("0"); setWellsAlternative("0"); setWellsHr("0"); setWellsImmobility("0"); setWellsPrev("0"); setWellsHemoptysis("0"); setWellsCancer("0");
                            toast.info("Campos da calculadora limpos.");
                          }}
                        ...
                        <Button
                          ...
                          onClick={() => {
                            ...
                            onApply(descText, `Wells: ${score} pts (${score > 4 ? 'Provável' : 'Improv'})`);
                            onClose(false);
                    ...
                    <div className="mt-4 p-4 rounded-2xl bg-slate-50/70 dark:bg-slate-900/40 backdrop-blur-md border border-slate-200/60 dark:border-slate-800/50 space-y-3">
                      ...
                      <div className="flex items-center gap-2">
                        <Button
                          ...
                          variant="outline"
                          onClick={() => {
                            setAlvaradoMigration("0"); setAlvaradoAnorexia("0"); setAlvaradoNausea("0"); setAlvaradoTenderness("0"); setAlvaradoRebound("0"); setAlvaradoFever("0"); setAlvaradoLeukocytosis("0"); setAlvaradoShift("0");
                            toast.info("Campos da calculadora limpos.");
                          }}
                        ...
                        <Button
                          ...
                          onClick={() => {
                            ...
                            onApply(descText, `Alvarado: ${score} pts (${score >= 7 ? 'Cirúrgico' : score >= 5 ? 'Obs' : 'Baixo'})`);
                            onClose(false);
                  ...
                  <div className="p-3 rounded-2xl bg-slate-50/70 dark:bg-slate-900/40 backdrop-blur-md border border-slate-200/60 dark:border-slate-800/50 space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      <Button
                        ...
                        variant="outline"
                        onClick={() => {
                          setGraceAge("0"); setGraceHr("0"); setGraceSbp("58"); setGraceCreatinine("1"); setGraceKillip("0"); setGraceCardiacArrest("0"); setGraceStDeviation("0"); setGraceEnzymes("0");
                          toast.info("Campos da calculadora limpos.");
                        }}
                      ...
                      <Button
                        ...
                        onClick={() => {
                          ...
                          onApply(descText, `GRACE: ${score} pts (${riskClass.split(" ")[0]})`);
                          onClose(false);
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Button
                        ...
                        onClick={() => {
                          ...
                          onApply(descText, `Ranson: ${score} pts (${riskClass.split(" ")[1]})`);
                          onClose(false);
