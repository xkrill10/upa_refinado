...
export function NihssModal({ isOpen, onClose, onApply }: NihssModalProps) {
  ...
  if (score === 0) {
    ...
    conduta =
      "Avaliação normal. Considerar outros diagnósticos diferenciais (ex: AIT resolvido).";
    riskColor = "bg-emerald-500 text-white";
  } else if (score >= 1 && score <= 4) {
    riskClass = "AVC LEVE";
    conduta =
      "Déficit neurológico leve. Avaliar indicação de trombólise dependendo das diretrizes institucionais.";
    riskColor = "bg-blue-500 text-white";
  } else if (score >= 5 && score <= 15) {
    riskClass = "AVC MODERADO";
    conduta =
      "Candidato potencial para trombólise venosa se dentro da janela terapêutica (< 4,5h). Protocolo AVC agudo urgente.";
    riskColor = "bg-amber-500 text-white";
  } else if (score >= 16 && score <= 20) {
    riskClass = "AVC MODERADO A GRAVE";
    conduta =
      "Alta probabilidade de oclusão de grandes vasos. Trombólise + avaliar trombectomia mecânica urgente.";
    riskColor = "bg-orange-600 text-white";
  } else {
    riskClass = "AVC GRAVE";
    conduta =
      "Déficit neurológico extenso. Alto risco de transformação hemorrágica e edema cerebral. Conduta imediata.";
        ...
        <div className="flex-1 overflow-y-auto px-6 py-2 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              ...
              <Select value={loc} onValueChange={setLoc}>
                ...
                <SelectContent className="text-xs">
                  ...
                  <SelectItem value="1">
                    1 - Sonolento, acorda com estímulo leve
                  </SelectItem>
                  <SelectItem value="2">
                    2 - Estupor, requer estímulo vigoroso
                  </SelectItem>
            ...
            <div className="space-y-1">
              ...
              <Select value={facial} onValueChange={setFacial}>
                ...
                <SelectContent className="text-xs">
                  ...
                  <SelectItem value="2">
                    2 - Paralisia parcial (inferior)
                  </SelectItem>
                  <SelectItem value="3">
                    3 - Paralisia completa (superior e inferior)
                  </SelectItem>
                </SelectContent>
              </Select>
            </div>
            ...
            <div className="space-y-1">
              ...
              <Select value={motorArmL} onValueChange={setMotorArmL}>
                ...
                <SelectContent className="text-xs">
                  ...
                  <SelectItem value="1">
                    1 - Cai antes de 10s, não bate na cama
                  </SelectItem>
                  <SelectItem value="2">
                    2 - Algum esforço contra gravidade, mas cai
                  </SelectItem>
                  <SelectItem value="3">
            ...
            <div className="space-y-1">
              ...
              <Select value={motorLegL} onValueChange={setMotorLegL}>
                ...
                <SelectContent className="text-xs">
                  ...
                  <SelectItem value="1">
                    1 - Cai antes de 5s, não bate na cama
                  </SelectItem>
                  <SelectItem value="2">
                    2 - Algum esforço contra gravidade, mas cai
                  </SelectItem>
            ...
            <div className="space-y-1 md:col-span-2">
              <Label className="text-[10px] font-black uppercase">
                11. Extinção / Inatenção (Negligência)
              </Label>
              <Select value={extinction} onValueChange={setExtinction}>
                ...
                <SelectContent className="text-xs">
                  ...
                  <SelectItem value="1">
                    1 - Inatenção visual, tátil, auditiva ou espacial parcial
                  </SelectItem>
                  <SelectItem value="2">
                    2 - Inatenção total (hemi-inatenção profunda)
                  </SelectItem>
                </SelectContent>
              </Select>
            </div>
