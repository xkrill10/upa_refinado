          ...
          <div className="md:col-span-4 space-y-3 border-r border-border/60 pr-4">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <p className="text-[10px] text-muted-foreground leading-relaxed pl-9">Richmond Agitation-Sedation Scale</p>
              </button>
                        ...
                        <Button
                          ...
                          onClick={() => {
                            ...
                            const descText = `- ESCALA SAD PERSONS (RISCO DE SUICÍDIO): ${score}/10 pontos (${riskClass.toUpperCase()}).\n  ` +
                              ...
                              `Conduta sugerida: ${recommendation}`;
                            onApply(descText, `SAD: ${score} pts (${riskClass.split(" ")[1] || "Baixo"})`);
                            onClose(false);
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <Select value={ciwaVisual} onValueChange={setCiwaVisual}>
                      ...
                      <SelectContent className="rounded-xl">
                        <SelectItem value="0">0 - Ausente (Sensibilidade normal)</SelectItem>
                        <SelectItem value="1">1 - Leve sensibilidade à luz</SelectItem>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Button
                          ...
                          onClick={() => {
                            ...
                            onApply(descText, `CIWA: ${score} pts (${score > 15 ? 'Grave' : score >= 8 ? 'Mod' : 'Leve'})`);
                            onClose(false);
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Button
                          ...
                          onClick={() => {
                            ...
                            onApply(descText, `CAGE: ${score}/4 (${score >= 2 ? 'Positivo' : 'Negativo'})`);
                            onClose(false);
                ...
                <div className="space-y-3 animate-in fade-in duration-200">
                  ...
                  <div className="p-3 rounded-xl bg-slate-50/70 dark:bg-slate-900/40 backdrop-blur-md border border-slate-200/60 dark:border-slate-800/50 space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Button type="button" onClick={() => { const descText = `- PHQ-9 (DEPRESSÃO): ${score}/27 pts (${severity.toUpperCase()}).\n  Conduta sugerida: ${recommendation}`; onApply(descText, `PHQ-9: ${score} pts (${severity.split(" ")[0]})`); onClose(false); toast.success("PHQ-9 integrado com sucesso!"); }} className="flex-1 h-10 rounded-xl font-bold uppercase tracking-wider text-[10px] bg-blue-600 hover:bg-blue-700 text-white">Confirmar e Aplicar ao Prontuário</Button>
                    </div>
                  </div>
                </div>
              );
                ...
                <div className="space-y-3 animate-in fade-in duration-200">
                  ...
                  <div className="p-3 rounded-xl bg-slate-50/70 dark:bg-slate-900/40 backdrop-blur-md border border-slate-200/60 dark:border-slate-800/50 space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Button type="button" onClick={() => { const descText = `- GAD-7 (ANSIEDADE): ${score}/21 pts (${severity.toUpperCase()}).\n  Conduta sugerida: ${recommendation}`; onApply(descText, `GAD-7: ${score} pts (${severity.split(" ")[1] || "Mín"})`); onClose(false); toast.success("GAD-7 integrado com sucesso!"); }} className="flex-1 h-10 rounded-xl font-bold uppercase tracking-wider text-[10px] bg-teal-600 hover:bg-teal-700 text-white">Confirmar e Aplicar ao Prontuário</Button>
                    </div>
                  </div>
                </div>
              );
