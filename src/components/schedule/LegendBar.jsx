...
const legend = [
  ...
  {
    sigla: "F",
    desc: "Folga Regulamentar (36h)",
    color: "bg-muted text-muted-foreground",
  },
  {
    sigla: "FE",
    desc: "Folga Enfermagem",
  ...
  {
    sigla: "LM",
    desc: "Licença Maternidade/Médica",
      ...
      <div className="flex flex-wrap gap-2">
        {legend.map((item) => (
          <div key={item.sigla} className="flex items-center gap-1.5">
            <span
              className={`inline-flex items-center justify-center h-5 w-5 rounded text-[9px] font-bold ${item.color}`}
            >
              {item.sigla}
            </span>
