...
export function MentalHealthCalculatorsModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[800px] rounded-[2rem] max-h-[90vh] flex flex-col !p-0 overflow-hidden gap-0">
              ...
              <div className="space-y-4 animate-in fade-in duration-200">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <Select
                      value={sadDepression}
                      onValueChange={setSadDepression}
                    >
                      <SelectTrigger className="h-9 rounded-xl">
                        <SelectValue />
                      </SelectTrigger>
                  ...
                  <div className="space-y-1">
                    ...
                    <Select
                      ...
                      onValueChange={setSadPrevAttempt}
                    >
                      <SelectTrigger className="h-9 rounded-xl">
                        <SelectValue />
                      </SelectTrigger>
                  ...
                  <div className="space-y-1">
                    ...
                    <Select
                      ...
                      onValueChange={setSadRationalLoss}
                    >
                      <SelectTrigger className="h-9 rounded-xl">
                        <SelectValue />
                      </SelectTrigger>
                  ...
                  <div className="space-y-1">
                    ...
                    <Select
                      ...
                      onValueChange={setSadSocialSupport}
                    >
                      <SelectTrigger className="h-9 rounded-xl">
                        <SelectValue />
                      </SelectTrigger>
                  ...
                  <div className="space-y-1">
                    ...
                    <Select
                      ...
                      onValueChange={setSadOrganizedPlan}
                    >
                      <SelectTrigger className="h-9 rounded-xl">
                        <SelectValue />
                      </SelectTrigger>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Button
                          ...
                          onClick={() => {
                            ...
                            onOpenChange(false);
                            toast.success(
                              "Escore CAGE integrated com sucesso!",
                            );
                          }}
                          className="flex-1 h-11 rounded-xl font-bold uppercase tracking-wider text-[10px] bg-primary text-primary-foreground"
                        >
