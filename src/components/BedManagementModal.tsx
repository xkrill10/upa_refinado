...
export function BedManagementModal({
  patient,
  bedName,
  bedSector,
  bedRoom,
  ...
  const admissionDateStr = patient?.arrivalTime
    ? new Date(patient.arrivalTime).toLocaleString("pt-BR")
    : "";
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
              <div
                style={{
                  ...
                  height: "40px",
                  borderRadius: "50%",
                  background: patient ? "#3b82f6" : "#10b981",
                  display: "flex",
                  alignItems: "center",
            ...
            {patient ? (
                ...
                <div className="bg-white dark:bg-slate-950 shadow-sm rounded-2xl border border-slate-200/60 dark:border-slate-800/80 p-5">
                  ...
                  >
                    ...
                    <div style={{ gridColumn: "1 / -1" }}>
                      ...
                      <div style={{ fontWeight: 600 }}>
                        {patient.comorbidities || "Nenhuma informada"}
                      </div>
                    </div>
                    {patient.allergies && (
                      <div style={{ gridColumn: "1 / -1" }}>
                            ...
                            >
                              ...
                              <div style={{ paddingLeft: "8px" }}>
                                {ev.type === "evolution" ? (
                                  <details
                                    open={isFirst}
                                    className="bg-white dark:bg-slate-950 shadow-sm rounded-xl border border-slate-200/60 dark:border-slate-800 overflow-hidden"
                                  >
                                    <summary
                                      style={{
                                        padding: "10px 14px",
              ...
              >
                ...
                <p style={{ color: "var(--muted-foreground)" }}>
                  Este leito não possui paciente no momento.
                </p>
              </div>
            )}
          </div>
