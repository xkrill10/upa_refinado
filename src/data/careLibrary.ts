...
export const CARE_LIBRARY: LibraryItem[] = [
  ...
  { name: "Balanço Hídrico (Rigoroso)", category: "nursing", dosage: "-", route: "-", frequency: "A cada troca/6h" },
  { name: "Sondagem Vesical (SVD)", category: "nursing", dosage: "Sonda de Foley", route: "Uretral", frequency: "Manter pérvio" },
  { name: "Sondagem Vesical (SVA)", category: "nursing", dosage: "Sonda de Alívio", route: "Uretral", frequency: "Agora" },
  { name: "Cuidados com SNG/SNE", category: "nursing", dosage: "-", route: "Gástrica/Enteral", frequency: "6/6h" },
  { name: "Controle de Diurese e Evacuação", category: "nursing", dosage: "-", route: "-", frequency: "Por plantão" },
  { name: "Prevenção de Lesão por Pressão", category: "nursing", dosage: "Hidratação/Coxins", route: "Leito", frequency: "2/2h" },
  { name: "Prevenção de Quedas", category: "nursing", dosage: "Grades elevadas", route: "Leito", frequency: "Tempo integral" },
  { name: "Aspiração de Vias Aéreas", category: "nursing", dosage: "-", route: "TOT/TQT/Oral", frequency: "S/N (Secreção)" },
  { name: "ECG (Eletrocardiograma)", category: "nursing", dosage: "12 Derivações", route: "-", frequency: "Agora" },
  { name: "Preparo para Transferência (Cross)", category: "nursing", dosage: "Jejum/Documentos", route: "-", frequency: "Agora" },
