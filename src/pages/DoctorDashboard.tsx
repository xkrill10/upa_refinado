...
const ROOMS = [
  ...
  {
    id: "CONSULTÓRIO CLÍNICO 1",
    name: "Consultório Clínico 1",
    type: "adult",
    icon: Stethoscope,
    color: "blue",
  },
  {
    id: "CONSULTÓRIO CLÍNICO 2",
    name: "Consultório Clínico 2",
    type: "adult",
    icon: Stethoscope,
    color: "blue",
  },
  {
    id: "CONSULTÓRIO CLÍNICO 3",
    name: "Consultório Clínico 3",
    type: "adult",
    icon: Stethoscope,
    color: "blue",
  },
  {
    id: "CONSULTÓRIO CLÍNICO 4",
    name: "Consultório Clínico 4",
    type: "adult",
    icon: Stethoscope,
    color: "blue",
  },
  {
    id: "CONSULTÓRIO CLÍNICO 5",
    name: "Consultório Clínico 5",
    type: "adult",
    icon: Stethoscope,
    color: "blue",
  },
  ...
  {
    id: "CONSULTÓRIO PEDIÁTRICO 1",
    name: "Consultório Pediátrico 1",
    type: "pediatric",
    icon: Baby,
    color: "orange",
  },
  {
    id: "CONSULTÓRIO PEDIÁTRICO 2",
    name: "Consultório Pediátrico 2",
    type: "pediatric",
    icon: Baby,
    color: "orange",
  },
  {
    id: "CONSULTÓRIO PEDIÁTRICO 3",
    name: "Consultório Pediátrico 3",
    type: "pediatric",
    icon: Baby,
    color: "orange",
  },
        ...
        {selectedRoom &&
          (() => {
            ...
            const willOverwrite =
              ...
              doctorName.trim() &&
              doctorName !== occupantOfSelectedRoom;
            const willResume =
              isSelectedRoomOccupied &&
              doctorName.trim() === occupantOfSelectedRoom;
                  ...
                  <DialogDescription className="text-white/80 font-medium text-sm">
                    {isSelectedRoomOccupied ? (
                      ...
                      <>
                        ...
                        {selectedRoom.name.toLowerCase().startsWith("sala")
                          ? "na"
                          : "no"}
                        <br />
                        <strong className="text-white">
                ...
                <div className="p-8 space-y-5">
                  <div className="space-y-2">
                    ...
                    <Input
                      value={doctorName}
                      onChange={(e) =>
                        setDoctorName(formatWords(e.target.value))
                      }
                  ...
                  {isSelectedRoomOccupied && (
                    ...
                    >
                      {willResume
                        ...
                        : willOverwrite
                          ? "Cuidado! Você irá encerrar a sessão do outro colega."
