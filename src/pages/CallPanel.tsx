...
export default function CallPanel() {
  ...
  const speak = useCallback(
    (call: { ticket?: string; patientName: string; room: string }) => {
      ...
      try {
        ...
        setTimeout(() => {
          ...
          const brVoice =
            voices.find(
              (v) =>
                (v.lang === "pt-BR" || v.lang === "pt_BR") && v.localService,
            ) ||
            voices.find(
  ...
  const testVoice = () => {
    ...
    const testCall = {
      ticket: "T000",
      patientName: "TESTE DE VOZ DO SISTEMA",
      room: "SALA DE VOZ",
    };
    if (!isAudioEnabled) {
  ...
  const getRoomIcon = (room: string) => {
    ...
    if (
      r.includes("AMARELA") ||
      r.includes("OBSERVAÇÃO") ||
      r.includes("MASCULINA") ||
      r.includes("FEMININA")
    )
      return Clock;
    if (
      r.includes("PEDIÁTRICA") ||
      r.includes("CRIANÇA") ||
      r.includes("INFANTIL")
    )
      return Baby;
            ...
            >
              ...
              <div className="space-y-4">
                <h2 className="text-3xl font-black tracking-tight text-slate-900 leading-tight">
                  Painel de Chamada Pronto
                </h2>
                <p className="text-slate-500 font-medium text-lg">
                  Para que as chamadas por voz funcionem, o navegador exige uma
                  interação inicial.
                </p>
              </div>
              <Button
          ...
          <div className="w-full flex items-center justify-between px-6">
            ...
            <div className="flex flex-col items-center shrink-0 select-none scale-90 origin-left">
              <div className="flex items-baseline italic">
                <span className="text-[#00A859] text-[58px] font-black tracking-tighter leading-none">
                  U
                </span>
                ...
                <span className="text-[#005BAB] text-[58px] font-black tracking-tighter leading-none ml-1">
                  24h
                </span>
              ...
              <span className="text-[11px] font-black text-slate-900 tracking-[0.2em] uppercase mt-[-4px]">
            ...
            <div className="flex items-center gap-5 shrink-0 origin-right">
              <div className="flex flex-col items-start leading-[0.7] select-none scale-90">
                <span className="text-[#E30613] font-black text-[12px] uppercase">
                  Cidade de
                </span>
                <span className="text-[#E30613] text-5xl font-black tracking-tighter">
                  Embu
                </span>
                <span className="text-[#E30613] font-black text-[12px] uppercase text-right w-full">
                  das Artes
                </span>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <Button
                  ...
                  onClick={() => {
                    if (
                      confirm(
                        "Deseja realmente RESETAR todo o sistema? Todos os nomes e chamadas serão apagados.",
                      )
                    ) {
                      resetSystem();
                    }
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-4 gap-8">
              ...
              >
                ...
                <div className="relative z-10 flex flex-col items-center space-y-12">
                  ...
                  >
                    ...
                    <h1 className="text-2xl font-black text-white tracking-[0.3em] uppercase opacity-90">
                      UPA DRA. ZILDA ARNS
                    </h1>
                    <p className="text-blue-400 font-bold text-[10px] tracking-[0.5em] uppercase mt-2">
                      Unidade de Pronto Atendimento - Embu das Artes
                    </p>
                  </motion.div>

                  <div className="flex flex-col items-center space-y-3">
                    <p className="text-slate-500 font-black text-sm tracking-[0.4em] uppercase">
                      Status do Sistema
                    </p>
                    <div className="flex items-center gap-3 bg-white px-6 py-2 rounded-full shadow-sm border border-slate-200">
                      <span className="flex h-3 w-3 rounded-full bg-emerald-500 animate-pulse" />
                      <span className="text-[#002B52] font-black text-xl tracking-widest uppercase">
                        Operação Normal
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="bg-white/5 backdrop-blur-md px-12 py-8 rounded-[2rem] border border-white/10 flex flex-col items-center">
                    ...
                    <p className="text-slate-400 font-bold text-[9px] tracking-widest uppercase mt-4">
                      Aguarde sua senha ser anunciada
                    </p>
                  </div>
                </div>
              ...
              >
                <Card
                  className={cn(
                    ...
                    UI_COLORS.primary,
                    isCalling &&
                      "ring-4 ring-emerald-500/50 shadow-[0_0_120px_rgba(52,211,153,0.3)]",
                  )}
                >
                  ...
                  <div className="mt-8 w-full flex flex-col md:flex-row items-center justify-center gap-12 relative z-10">
                    <div className="flex flex-col items-center group">
                      <span className="text-xs font-black uppercase tracking-[0.4em] mb-3 text-slate-500">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between px-4 mb-4">
            <h3 className="text-sm font-black uppercase tracking-[0.3em] text-[#002B52]">
              Chamadas Recentes
            </h3>
            <History
              className={cn(
                  ...
                  <div className="flex items-center gap-5 pl-4">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-2xl font-black text-[#001A33] uppercase tracking-tight truncate leading-none">
                        {call.patientName
                          ? formatPatientNameLGPD(call.patientName)
                          : "PACIENTE"}
                      </p>
                    </div>
                  </div>
