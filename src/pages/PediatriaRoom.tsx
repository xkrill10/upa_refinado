...
export default function PediatriaRoom() {
  ...
  const [selectedRoom, setSelectedRoom] = useState(
    () => localStorage.getItem("upa_active_room") || "SALA PEDIATRIA",
  );
            ...
            {[
              {
                ...
                status: occupiedRooms["TRIAGEM PEDIÁTRICA 1"]
                  ? "ocupado"
                  : "livre",
              },
              {
                id: "TRIAGEM PEDIÁTRICA 2",
                status: occupiedRooms["TRIAGEM PEDIÁTRICA 2"]
                  ? "ocupado"
                  : "livre",
              },
              {
                id: "OBSERVAÇÃO PEDIÁTRICA",
                status: occupiedRooms["OBSERVAÇÃO PEDIÁTRICA"]
                  ? "ocupado"
                  : "livre",
              },
            ].map((room) => (
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
                              ...
                              <div className="lg:col-span-4 space-y-4 flex flex-col">
                                ...
                                <div
                                  ...
                                  className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-border shadow-soft relative overflow-hidden group cursor-pointer hover:border-[#8b5cf6]/30 transition-all active:scale-[0.98] flex flex-col justify-center h-[300px]"
                                >
