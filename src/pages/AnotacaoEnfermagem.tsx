...
export default function AnotacaoEnfermagem() {
  const { id } = useParams();
  ...
  const [evolutionType, setEvolutionType] = useState("Anotação de Enfermagem");
  ...
  useEffect(() => {
    if (isExpressMode && !isFormOpen) {
      ...
      setEvolutionType("Anotação de Enfermagem");
    }
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex flex-col gap-1">
            <div className="flex items-center gap-3">
              ...
              <span className="text-[10px] font-black uppercase bg-cyan-500/10 text-cyan-600 px-2 py-1 rounded-md border border-cyan-500/20">
                Anotação Técnica
              </span>
              <Badge
                ...
                onClick={() => {
                  ...
                  if (isFormOpen) {
                    if (tab.id === "prescriptions") {
                      handleEvolutionTypeChange("Anotação de Enfermagem");
