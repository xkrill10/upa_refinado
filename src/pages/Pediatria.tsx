    ...
    >
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        <div className="flex items-center gap-3">
          <div className="h-10 w-10 rounded-2xl bg-orange-500/10 dark:bg-orange-500/20 flex items-center justify-center shadow-sm">
            <Baby className="h-6 w-6 text-orange-500 dark:text-orange-400" />
          </div>
          <div>
            <h1 className="text-2xl font-black tracking-tight text-[#006699] dark:text-orange-400 uppercase flex items-center gap-2">
              Pediatria
            </h1>
            <p className="text-muted-foreground text-[10px] font-black uppercase tracking-widest">
              Atendimento infantil de 0 a 11 anos
            </p>
          </div>
        </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                  ...
                                  <div className="bg-white dark:bg-slate-900 rounded-[2rem] p-6 border border-border shadow-soft flex items-center gap-6">
                                    ...
                                    <div className="grow min-w-0 space-y-2">
                                      ...
                                      <Input
                                        placeholder="Em uso..."
                                        className="h-12 rounded-[1.25rem] border-none bg-sky-500/5 font-bold px-4 focus-visible:bg-white transition-all shadow-inner"
                                        value={clinicalData.currentMedications}
                                        onChange={(e) =>
                                          setClinicalData((prev) => ({
                                            ...prev,
                                            currentMedications:
                                              formatMedicalText(e.target.value),
                                          }))
                                        }
                                      />
                                    </div>
