...
export function EvolutionFormPanel({
  ...
  const {
    ...
    isBedDialogOpen,
    setIsBedDialogOpen,
    isClinicalProfileOpen,
    setIsClinicalProfileOpen,
    isVitalsHistoryOpen,
    setIsVitalsHistoryOpen,
    isBedRequestOpen,
    setIsBedRequestOpen,
    openBedTransfer,
    setOpenBedTransfer,
              ...
              {(evolutionType === "Evolução Enfermagem" ||
                ...
                >
                  ...
                  {evolutionType === "Evolução Enfermagem" ? (
                    ...
                    <p className="text-muted-foreground leading-relaxed text-[11px]">
                      <strong>Dados Brutos e Pontuais (Toda a Equipe):</strong>{" "}
                      Registro imediato de fatos observados ou executados (ex:
                      administração de medicação com via/dose, banho, curativos,
                      etc.). Serve de subsídio para a evolução do enfermeiro.
                    </p>
                  )}
                </motion.div>
              )}
                      ...
                      <div className="relative clinical-dropdown-container">
                        ...
                        >
                          <div className="flex items-center gap-2">
                            ...
                            <span>
                              {(() => {
                                const selectedItem = DISCHARGE_TYPE_ITEMS.find(
                                  (item) =>
                    ...
                    >
                      ...
                      <div className="relative clinical-dropdown-container">
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2">
                            {(() => {
                              const count = MEDICAL_PHYSICAL_NEURO_ITEMS.filter(
                                (item) =>
                                  normalizeText(description).includes(
                                    normalizeText(item.text).trim(),
                                  ),
                      ...
                      <div className="relative clinical-dropdown-container">
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2">
                            {(() => {
                              const count =
                                PEDIATRIC_PHYSICAL_NEURO_ITEMS.filter((item) =>
                                  normalizeText(description).includes(
                                    normalizeText(item.text).trim(),
                                  ),
                                ).length;
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <svg
                              ...
                              className={cn(
                                "lucide lucide-chevron-down text-muted-foreground/60 transition-transform duration-200",
                                isComfortDropdownOpen && "transform rotate-180",
                              )}
                            >
                              <path d="m6 9 6 6 6-6" />
                            </svg>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {renderPanelDropdown(
                      ...
                      isSocialEvalDropdownOpen,
                      () => {
                        setIsSocialEvalDropdownOpen(!isSocialEvalDropdownOpen);
                    ...
                    {renderPanelDropdown(
                      ...
                      "amber",
                      isChild ? SOCIAL_PED_PROCEDURES : SOCIAL_ADULT_PROCEDURES,
                      isSocialProcDropdownOpen,
                      () => {
                        setIsSocialProcDropdownOpen(!isSocialProcDropdownOpen);
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <svg
                              ...
                              className={cn(
                                "lucide lucide-chevron-down text-muted-foreground/60 transition-transform duration-200",
                                isSaeCareDropdownOpen && "transform rotate-180",
                              )}
                            >
                              <path d="m6 9 6 6 6-6" />
                            </svg>
                          ...
                          <div className="flex items-center justify-between w-full mb-1.5">
                            ...
                            >
                              <Baby
                                className={cn(
                                  "h-3.5 w-3.5",
                                  selectedPews ? "text-white" : "text-teal-600",
                                )}
                              />
                            </div>
                          </div>
