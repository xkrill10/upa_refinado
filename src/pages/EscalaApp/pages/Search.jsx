            ...
            return (
              <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
                ...
                <motion.div
                  ...
                  className="relative w-full max-w-md glass-card-premium rounded-xl shadow-2xl p-6 z-10 flex flex-col gap-4 overflow-hidden cursor-grab active:cursor-grabbing"
                >
                  {/* Close Button */}
                  <button
                    onClick={() => setSelectedEmployee(null)}
