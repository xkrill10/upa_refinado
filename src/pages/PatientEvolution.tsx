  ...
  return (
    <button
      ...
      className={cn(
        ...
        isEvaluated
          ? `${t.bg} ${t.border}`
          : `bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800 ${t.badgeHover}`
      )}
    >
      <div className="flex items-center gap-1.5 w-full">
         <div className={cn("p-1 rounded-md shrink-0 transition-colors duration-300", isEvaluated ? t.iconBg : t.iconDefault)}>
           {icon}
         </div>
