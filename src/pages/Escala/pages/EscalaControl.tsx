...
import db from "@/pages/Escala/api/dbClient";
...
import {
  ...
  TableHeader,
  TableRow,
} from "@/pages/Escala/components/ui/table";
...
import {
  ...
  SelectTrigger,
  SelectValue,
} from "@/pages/Escala/components/ui/select";
import {
  Tabs,
  TabsList,
  TabsTrigger,
  TabsContent,
} from "@/pages/Escala/components/ui/tabs";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
  ...
  DropdownMenuTrigger,
} from "@/pages/Escala/components/ui/dropdown-menu";
import { motion, AnimatePresence } from "framer-motion";
import { toast } from "sonner";
import { cn } from "@/pages/Escala/lib/utils";
import {
  CalendarDays,
  Clock,
  ShieldAlert,
...
import {
  ...
  DialogDescription,
  DialogFooter,
} from "@/pages/Escala/components/ui/dialog";
import { useScaleSettings } from "@/pages/Escala/hooks/useScaleSettings";
    ...
    switch (shiftId) {
      ...
      case "noturno_b":
        return {
          ...
          badge:
            "bg-indigo-650/10 text-indigo-650 dark:text-indigo-400 border-indigo-500/20",
        };
      case "rt_lideranca":
        return {
          bg: "bg-emerald-600",
                ...
                <div className="border-b bg-card px-4 py-2 flex items-center justify-between shadow-sm shrink-0 no-print overflow-x-auto flex-nowrap gap-4 whitespace-nowrap hide-scrollbar">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="hidden sm:flex bg-muted rounded-md p-0.5 h-7">
                      <button
                        ...
                        className={cn(
                          "text-[11px] px-3 h-full rounded transition-all",
                          globalShiftFilter === "all"
                            ? "font-bold bg-background shadow-sm text-foreground"
                  ...
                  <div className="flex items-center gap-2 flex-nowrap">
                    ...
                    <Button
                      variant="outline"
                      size="sm"
                      className="gap-1.5 h-7 text-xs no-print hidden xl:flex"
                    >
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 no-print">
                    ...
                    <div
                      className={cn(
                        "rounded-xl p-3 border shadow flex flex-col items-center justify-center gap-0.5 cursor-pointer transition-all hover:scale-[1.03]",
                        globalShiftFilter === "par_noturno"
                          ? "bg-indigo-600 border-indigo-700 shadow-indigo-200 dark:shadow-indigo-900"
                        ...
                        <SelectContent>
                          ...
                          {shifts.map((s) => {
                            ...
                            if (s.id === "rt_lideranca")
                              ...
                              icon = (
                                <MoonStar className="w-3 h-3 inline-block mr-1.5 text-slate-800 fill-slate-800 dark:text-slate-200 dark:fill-slate-200" />
                              );
                            return (
                            ...
                            {filteredGlobals.length === 0 ? (
                              ...
                              (() => {
                                const STATUS_STYLES = {
                                  ...
                                  "off-duty": {
                                    bg: "bg-transparent",
                                    text: "text-slate-350 dark:text-slate-700",
                      ...
                      <div className="p-4 bg-white border border-slate-300 rounded-xl flex flex-col gap-2 text-xs print-legend">
                        ...
                        <div className="flex flex-wrap gap-x-6 gap-y-3 items-center mt-1">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-slate-800 text-[10px] font-semibold">
                              Ímpar Diurno
                            </span>
                          </div>
                          <div className="flex items-center gap-2">
                    ...
                    <SelectContent>
                      {shifts.map((group) => {
                        ...
                        if (group.id === "rt_lideranca")
                          ...
                          icon = (
                            <MoonStar className="w-3.5 h-3.5 inline-block mr-1.5 text-slate-800 fill-slate-800 dark:text-slate-200 dark:fill-slate-200" />
                          );
